...
},{"./cjs/react-dom.development.js":"../node_modules/react-dom/cjs/react-dom.development.js"}],"Number.js":[function(require,module,exports) {
"use strict";
...
var Number = function Number(props) {
  return _react.default.createElement("p", {
    onClick: props.numClicked,
    className: "number cell grey"
  }, props.num);
};

var _default = Number;
exports.default = _default;
},{"react":"../node_modules/react/index.js"}],"Operator.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"react":"../node_modules/react/index.js"}],"Clear.js":[function(require,module,exports) {
"use strict";
...
function (_Component) {
  ...
  function App(props) {
    ...
    _this.numberClicked = function (e) {
      if (!_this.state.last) {
        _this.setState({
        ...
        if (_this.state.op === "+") {
          _this.setState({
            ...
            _this.setState({
              res: _this.state.last + _this.state.next
            }, function () {
              _this.setState({
                last: _this.state.res,
                next: undefined
              }, function () {
                console.log("res ".concat(_this.state.res), "last ".concat(_this.state.last, " "), "next ".concat(_this.state.next, " "));
              });
            });
          });
        }
    ...
    _this.opClicked = function (e) {
      _this.setState({
        op: e.target.textContent
      }, function () {
        console.log(_this.state.op);
      });
    };
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        className: "results"
      }, this.state.res, " "), _react.default.createElement("div", {
        className: "main"
      }, _react.default.createElement("div", {
        className: "main__left"
      }, _react.default.createElement(_Clear.default, {
        className: "clear cell grey"
      }), _react.default.createElement("div", {
        className: "main__left__number"
      }, numbers.map(function (numb, i) {
        var ii = i.toString();
        return _react.default.createElement(_Number.default, {
          numClicked: _this2.numberClicked,
          key: ii,
          num: numb
        });
      }))), _react.default.createElement("div", {
        className: "main__right"
      }, operators.map(function (ope, i) {
        var ii = i * 10;
        ii.toString();
        return _react.default.createElement(_Operator.default, {
          opClicked: _this2.opClicked,
          key: ii,
          op: ope
        });
      }))));
...
var _default = App;
exports.default = _default;
},{"react":"../node_modules/react/index.js","./Number":"Number.js","./Operator":"Operator.js","./Clear":"Clear.js","./style.css":"style.css"}],"index.js":[function(require,module,exports) {
"use strict";
